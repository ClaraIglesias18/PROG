...
public class Ilc {
                ...
                case 1:
                    ...
                    switch (op2) {
                        ...
                        case 3:
                            ...
                            break;
                        default:
                            System.out.println("No es correcta esa opcion (" + op + ")");                
    ...
    public void eliminaMed (Clinica clinica) {
        
        System.out.println("\nEliminacion de medico");
        System.out.println("\n----------------------");
                
        int pos = leeEntero("Indique la posicion del medico: ");
        
        
        
        clinica.eliminaMedico(pos);
